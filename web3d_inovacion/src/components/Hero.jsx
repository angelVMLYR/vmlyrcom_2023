      ...
      mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Welcome, We are <span className='text-[#915eff]'>VMLYR COMMERCE MX</span>
          </h1>

          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            For this event we created this interactive web platform <br className='sm:block hidden'/> in which you can view our work, we hope you enjoy it :)
          </p>
        </div>
      </div>
